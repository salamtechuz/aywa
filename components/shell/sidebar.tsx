...
export function Sidebar({ workspaceName, workspaceSlug, workspacePlan, workspaceLogo }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "hidden md:flex sticky top-0 h-screen shrink-0 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground transition-[width] duration-200",
